...
[![异常调用堆栈](_v_images/20200828143517657_13525.png "异常调用堆栈")](http://nodejs.cn/static/e4594b6135efd353b44770f748fdccd5/1b853/exception-call-stack.png)
...
[![调用堆栈的第一个示例](_v_images/20200828143517437_6779.png "调用堆栈的第一个示例")](http://nodejs.cn/static/270ebeb6dbfa7d613152b71257c72a9e/11a8f/call-stack-first-example.png)

每次迭代中的事件循环都会查看调用堆栈中是否有东西并执行它直到调用堆栈为空：

[![执行顺序的第一个示例](_v_images/20200828143517224_6744.png "执行顺序的第一个示例")](http://nodejs.cn/static/ca404c319c6fc595497d5dc097d469ff/fc1a1/execution-order-first-example.png)
...
[![调用堆栈的第二个示例](_v_images/20200828143517111_6843.png "调用堆栈的第二个示例")](http://nodejs.cn/static/be55515b9343074d00b43de88c495331/966a0/call-stack-second-example.png)

这是程序中所有函数的执行顺序：

[![执行顺序的第二个示例](_v_images/20200828143516899_5384.png "执行顺序的第二个示例")](http://nodejs.cn/static/585ff3207d814911a7e44d55fbde483b/f96db/execution-order-second-example.png)
